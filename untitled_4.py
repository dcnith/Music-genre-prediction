...
data_train['danceability'] = data_train['danceability'].fillna(data_train['danceability'].median())
data_train['duration'] = data_train['duration'].fillna(data_train['duration'].median())
data_train['energy'] = data_train['energy'].fillna(data_train['energy'].median())
data_train['loudness'] = data_train['loudness'].fillna(data_train['loudness'].median())
data_train['positiveness'] = data_train['positiveness'].fillna(data_train['positiveness'].median())
data_train['speechiness'] = data_train['speechiness'].fillna(data_train['speechiness'].median())
